...
export const languageItemList = [
    {
        date: 'September 2019',
        description: 'A simple game to help learners focus on the stress in academic vocabulary.',
...
export const mathItemList = [
    {
        date: 'April 2019',
        description: 'This is an attempt to make it easier to just physically draw a graph and then see what the equation is for that graph.',
